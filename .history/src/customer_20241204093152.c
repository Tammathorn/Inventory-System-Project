...
int customer_system() {
    ...
    do {
        ...
        do {
            ...
            printf("current number order : %d, amount_warehose : %d", current_number_order, amount_warehouse);
            ...
            printf("Name : %s Quantity : %d", data_name, data_number);
            printf(" Add to the basket\n");
          
            
            if (current_number_order < -1) {
                break;
            } 
        }
